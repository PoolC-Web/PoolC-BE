...
public class MemberDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        memberRepository.save(
                Member.builder()
                        .UUID(UUID.randomUUID().toString())
                        .loginID("UNACCEPTED_MEMBER_ID1")
                        .passwordHash(passwordHashProvider.encodePassword("UNACCEPTED_MEMBER_PASSWORD"))
                        .email("unaccepted1@email.com")
                        .phoneNumber("010-5555-5551")
                        .name("UNACCEPTED_MEMBER_NAME1")
                        .department("exampleDepartment")
        ...
        memberRepository.save(
                Member.builder()
                        .UUID(UUID.randomUUID().toString())
                        .loginID("UNACCEPTED_MEMBER_ID2")
                        .passwordHash(passwordHashProvider.encodePassword("UNACCEPTED_MEMBER_PASSWORD"))
                        .email("unaccepted2@email.com")
                        .phoneNumber("010-5555-5552")
                        .name("UNACCEPTED_MEMBER_NAME2")
                        .department("exampleDepartment")
        ...
        memberRepository.save(
                Member.builder()
                        .UUID(UUID.randomUUID().toString())
                        .loginID("UNACCEPTED_MEMBER_ID3")
                        .passwordHash(passwordHashProvider.encodePassword("UNACCEPTED_MEMBER_PASSWORD"))
                        .email("unaccepted3@email.com")
                        .phoneNumber("010-5555-5553")
                        .name("UNACCEPTED_MEMBER_NAME3")
                        .department("exampleDepartment")
